                                        ...
                                        Image(uiImage: self.imagePicker.selectedPhotos[img].image)
                                            ...
                                            .overlay(
                                                ZStack(alignment: .center) {
                                                    BlurView(style: .systemUltraThinMaterial).opacity(self.imagePicker.selectedPhotos[img].progress >= 1.0 ? 0 : 1).animation(.easeInOut)
                                                ...
                                                Circle()
                                                    ...
                                                    .padding(4)
                                                    .opacity(self.imagePicker.selectedPhotos[img].progress >= 1.0 ? 0 : 1)
                                                    .animation(.easeInOut)
