    ...
    var body: some View {
        ...
        HStack {
            ...
            VStack(alignment: .leading) {
                ...
                HStack(spacing: 5) {
                    Text((self.dialogModel.isOpen ? (self.dialogModel.dialogType == "private" ? (self.privateDialogContact.isOnline ? "online now" : "last online \(self.privateDialogContact.lastOnline.getElapsedInterval(lastMsg: "moments")) ago") : (self.dialogModel.dialogType == "public" ? "\(self.dialogModel.publicMemberCount) members" : "\(self.dialogModel.occupentsID.count) people") + (self.dialogModel.onlineUserCount != 0 ? " " : "")) : dialogModel.lastMessage))
