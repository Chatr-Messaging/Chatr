...
struct MainBody: View {
    ...
    @State var cardDrag1 = CGSize.zero
    @State var cardDrag2 = CGSize.zero
    @State var cardDrag3 = CGSize.zero
    @State var cardDrag4 = CGSize.zero
    @State var cardDrag5 = CGSize.zero
    @Binding var presentView: Bool
        ...
        ZStack {
            VStack(alignment: .center) {
                ...
                HStack(alignment: .center) {
                    ...
                    .frame(maxWidth: 210)
                    .overlay(RoundedRectangle(cornerRadius: 15).stroke(Color.white.opacity(0.14), lineWidth: 2.5).blur(radius: 2))
                    .disabled(self.continuePermissions || self.continuePt1 ? true : false)
                    .shadow(color: Color("buttonShadow"), radius: 20, x: 0, y: 10)
            ...
            PermissionsView(continuePt1: self.$continuePt1, permisContinue: self.$continuePermissions, contactsPermission: self.$contactsPermission, locationPermission: self.$locationPermission, notificationPermission: self.$notificationPermission, photoPermission: self.$photoPermission, cameraPermission: self.$cameraPermission)
                .frame(minHeight: 240, idealHeight: 400, maxHeight: 485, alignment: .center)
                .frame(maxWidth: 400)
                ...
                .offset(x: self.cardDrag1.width / 8, y: self.cardDrag1.height / 8)
                .rotation3DEffect(.degrees(-Double(self.cardDrag1.width) / 40), axis: (x: 0, y: 1, z: 0))
                .rotation3DEffect(.degrees(Double(self.cardDrag1.height / 40)), axis: (x: 1, y: 0, z: 0))
                .animation(.spring(response: 0.45, dampingFraction: 0.45, blendDuration: 0))
                .gesture(DragGesture()
                            .onChanged { self.cardDrag1 = $0.translation }
                            .onEnded { _ in
            ...
            PhoneNumberView(continuePt1: $continuePt1, text: self.$text, textArea: self.$textArea)
                ...
                .offset(x: self.cardDrag2.width / 8, y: self.cardDrag2.height / 8)
                .rotation3DEffect(.degrees(-Double(self.cardDrag2.width) / 40), axis: (x: 0, y: 1, z: 0))
                .rotation3DEffect(.degrees(Double(self.cardDrag2.height / 40)), axis: (x: 1, y: 0, z: 0))
                .animation(.spring(response: 0.45, dampingFraction: 0.45, blendDuration: 0))
                .gesture(DragGesture()
                            .onChanged { self.cardDrag2 = $0.translation }
                            .onEnded { _ in
                    withAnimation(.spring()) {
                        self.cardDrag2 = .zero
                    }
            ...
            VerifyNumberView(text: self.$text, textArea: self.$textArea)
                ...
                .animation(.spring(response: 0.48, dampingFraction: 0.45, blendDuration: 0))
                .KeyboardAwarePadding()
                .offset(x: self.cardDrag3.width / 8, y: self.cardDrag3.height / 8)
                .rotation3DEffect(.degrees(-Double(self.cardDrag3.width) / 40), axis: (x: 0, y: 1, z: 0))
                .rotation3DEffect(.degrees(Double(self.cardDrag3.height / 40)), axis: (x: 1, y: 0, z: 0))
                .animation(.spring(response: 0.45, dampingFraction: 0.45, blendDuration: 0))
                .gesture(DragGesture()
                            .onChanged { self.cardDrag3 = $0.translation }
                            .onEnded { _ in
                    withAnimation(.spring()) {
                        self.cardDrag3 = .zero
                    }
            ...
            AddInfoView(continuePt4: self.$continuePt4)
                ...
                .animation(.spring(response: 0.48, dampingFraction: 0.45, blendDuration: 0))
                .KeyboardAwarePadding()
                .offset(x: self.cardDrag4.width / 8, y: self.cardDrag4.height / 8)
                .rotation3DEffect(.degrees(-Double(self.cardDrag4.width) / 40), axis: (x: 0, y: 1, z: 0))
                .rotation3DEffect(.degrees(Double(self.cardDrag4.height / 40)), axis: (x: 1, y: 0, z: 0))
                .animation(.spring(response: 0.45, dampingFraction: 0.45, blendDuration: 0))
                .gesture(DragGesture()
                            .onChanged { self.cardDrag4 = $0.translation }
                            .onEnded { _ in
                    withAnimation(.spring()) {
                        self.cardDrag4 = .zero
                    }
            ...
            AddProfileImageView(continuePt3: self.$continuePt3, continuePt4: self.$continuePt4, presentView: self.$presentView)
                ...
                .animation(.spring(response: 0.48, dampingFraction: 0.45, blendDuration: 0))
                .offset(x: self.cardDrag5.width / 8, y: self.cardDrag5.height / 8)
                .rotation3DEffect(.degrees(-Double(self.cardDrag5.width) / 40), axis: (x: 0, y: 1, z: 0))
                .rotation3DEffect(.degrees(Double(self.cardDrag5.height / 40)), axis: (x: 1, y: 0, z: 0))
                .animation(.spring(response: 0.45, dampingFraction: 0.45, blendDuration: 0))
                .gesture(DragGesture()
                            .onChanged { self.cardDrag5 = $0.translation }
                            .onEnded { _ in
                    withAnimation(.spring()) {
                        self.cardDrag5 = .zero
                    }
            ...
            .background(
                Image("Walkthrough BG1")
                    ...
                    .frame(width: Constants.screenWidth * 2, height: Constants.screenHeight, alignment: .leading)
                    .blur(radius: 8)
        ...
        VStack(alignment: .center, spacing: 0) {
            ...
            if auth.verifyCodeStatus == .success {
                ...
                VerifyCodeTextFieldView(text: $textCode, isFirstResponder: $auth.verifyPhoneStatusKeyboard)
                    ...
                    .frame(height: 54)
                    .lineLimit(1)
                    .overlay(RoundedRectangle(cornerRadius: 15).stroke(Color.red.opacity(0.6), lineWidth: 2.5))
                    .shadow(color: Color("buttonShadow").opacity(0.65), radius: 8, x: 0, y: 5)
                    .padding(.horizontal, 30)
            ...
            .disabled(auth.verifyCodeStatus == .error || auth.verifyCodeStatus == .undefined || auth.verifyCodeStatus != .success || auth.verifyCodeStatus != .loading ? false : true)
            .buttonStyle(ClickButtonStyle())
            .padding(.vertical)
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            if self.text.count > 3 && self.loadingSetName == false {
                ...
                .padding(.horizontal, 60)
                .padding(.vertical)
                .shadow(color: Color("buttonShadow").opacity(0.65), radius: 10, x: 0, y: 10)
            } else {
                Button(action: {
                    UINotificationFeedbackGenerator().notificationOccurred(.error)
                }) {
                    HStack(alignment: .center, spacing: 10) {
                        Text(self.loadingSetName ? "Saving Name" : "Save Name")
                            .fontWeight(.semibold)
                            .foregroundColor(.secondary)
                ...
                Button(action: {
                    ...
                    ZStack {
                        BlurView(style: .prominent)
                            ...
                            .cornerRadius(55)
                            .shadow(color: Color("buttonShadow").opacity(0.65), radius: 10, x: 0, y: 6)
